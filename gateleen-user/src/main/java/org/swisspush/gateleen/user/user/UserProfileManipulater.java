...
import org.swisspush.gateleen.user.user.UserProfileConfiguration.ProfileProperty;
...
public class UserProfileManipulater {
    ...
    public JsonObject createInitialProfile(MultiMap headers, String userId, Collection<ProfileProperty> profileProperties) {
     ...
     */
    protected int enrichProfile(MultiMap headers, JsonObject profile, String userId, Collection<ProfileProperty> profileProperties) {
        int updateCount = 0;
     ...
     * the update strategy {@link ProfileProperty#getUpdateStrategy()} and the header value is valid.
     *
     * @return <code>true</code>: Field updated. <code>false</code>: Not updated.
     */
    public boolean updateField(String userId, MultiMap headers, JsonObject profile, ProfileProperty profileProperty) {
        // Value in header
