...
public class RedisQueueCircuitBreakerStorageTest {
    ...
    public void testUpdateStatistics(TestContext context){
        ...
        storage.updateStatistics(endpoint, "req_1", 1, 1, 3, QueueResponseType.SUCCESS).setHandler(event -> {
            ...
            storage.updateStatistics(endpoint, "req_2", 2, 1, 3, QueueResponseType.SUCCESS).setHandler(event1 -> {
                ...
                storage.updateStatistics(endpoint, "req_3", 3, 1, 3, QueueResponseType.SUCCESS).setHandler(event2 -> {
                    ...
                    storage.updateStatistics(endpoint, "req_4", 4, 1, 3, QueueResponseType.SUCCESS).setHandler(event3 -> {
                        context.assertEquals(3L, jedis.zcard(key(endpoint, QueueResponseType.SUCCESS)));
