 ...
 */
public class ReOpenCircuitRedisCommand implements RedisCommand {
    ...
    public ReOpenCircuitRedisCommand(LuaScriptState luaScriptState, List<String> keys, List<String> arguments,
            ...
            if (event.succeeded()) {
                ...
                if (message != null && message.startsWith("NOSCRIPT")) {
                    ...
                    if (executionCounter > 10) {
                        ...
                        luaScriptState.loadLuaScript(new ReOpenCircuitRedisCommand(luaScriptState, keys, arguments,
                                redisProvider, log, promise), executionCounter);
                    }
                } else {
                    promise.fail("ReOpenCircuitRedisCommand request failed with message: " + message);
                }
            }
        })).onFailure(throwable -> promise.fail("Redis: ReOpenCircuitRedisCommand request failed with message: "
